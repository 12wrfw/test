...
function Library:CreatePopup(Config)
    ...
    Library:AddToRegistry(PopupOuter, {
    ...
    local WelcomeTextHeight = select(2, Library:GetTextBounds(WelcomeText, Enum.Font.Code, 14, Vector2.new(Width - 32, math.huge)));
    WelcomeLabel.Size = UDim2.new(1, 0, 0, math.max(20, WelcomeTextHeight + 4));
    ...
    task.wait();
    UpdateLogContainer.Size = UDim2.new(1, 0, 0, UpdateLogLayout.AbsoluteContentSize.Y);
