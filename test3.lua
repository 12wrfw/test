...
function Library:CreatePopup(Config)
    ...
    if not UpdateLogTitle then
        local DateStr = pcall(function() return os.date("%d/%m/%Y") end) and os.date("%d/%m/%Y") or "Unknown";
        UpdateLogTitle = "Update Log - " .. DateStr;
    end;
        ...
        local Success, Data = pcall(function()
            if writefile and readfile and isfile then
                if isfile(PopupDataFile) then
                    ...
                    if FileContent and HttpService then
                        return HttpService:JSONDecode(FileContent);
                    end;
                end;
            elseif Library.SaveManager then
    ...
    local function SavePopupData(Data)
        pcall(function()
            if writefile and HttpService then
                writefile(PopupDataFile, HttpService:JSONEncode(Data));
            elseif Library.SaveManager then
